<div class="modal fade" id="registrarse" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
        ...
        {{--  onsubmit="return validarEmail();"  --}}
            {{--  <form class="shadow form--frm--userRegistro col-md-12 col-12 p-4 rounded-3" action="{{route('create.user.index')}}" onsubmit="return validarEmail()" method="POST" >  --}}
              ...
              <h2 class="fw-normal text-center mb-4">Crear Cuenta</h2>
                  <div class="mb-3">
                    <input type="text" class="form-control input--frm--userLog inputName" name="nombre" placeholder="Ingrese su nombre" required/>
                </div>
                <div class="mb-3 groud--email">
                    <input type="email" class="form-control  input--frm--userLog inputEmail" id="inputEmail"  name="email" placeholder="Tu correo electronico " required/>
                    <span class="text--frm--msgVacio">El correo que ingresastes ya existe , porfavor ingrese otro correo para continuar con el registro, gracias.</span>
                ...
                <div class="mb-3">
                    <input type="password" class="form-control input--frm--userLog inputPass1" id="exampleInputPassword1" name="pass1" placeholder="Ingresa la contraseña" required/>
                </div>
                <div class="mb-4">
                    <input type="password" class="form-control input--frm--userLog inputPass2" id="exampleInputPassword2" name="pass2" placeholder="Vuelva a ingresar su contraseña" required/>
                </div>
                <div class="mb-3 form-check">
                  ...
                  <div class="mb-3 form-check">
                      ...
                      <label class="form-check-label" for="checkTermino2">Acepto la Compra Segura y Políticas de Privacidad</label>
                  </div>
