<div class="modal fade modal-general" id="recuperarCuenta" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
    tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal--frm--userLog">
        <div class="modal-content ">
            <form class="shadow form--frm--userRecuperar col-md-12 col-12 p-4 rounded-3" id="formBody"
                ...
                {{--  </div>  --}}
                {{--  <button type="submit" class="btn col-12 btn-primary">Restablecer la contraseña</button>  --}}
                <div class="mb-3 d-flex justify-content-center" id="formBtnEnvio">
                    <a class="btn col-12 btn-primary" id="btnEnvioRecu">Restablecer la contraseña</a>
                </div>
