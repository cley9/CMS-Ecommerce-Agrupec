...
<div class="container boxContainerCart">
  <div class="row">
                ...
                <div class="row col d-flex aling-items-center">
                    <div class="col-4 col-md-2">
                        <a href="{{ route('View.home.index', $productoArray->id) }}">
                            <img src="{{ asset('storage/img/Productos/' . $productoArray->imagen) }}" class="card-img-top"
                    ...
                    <div class="col col-md-4">
                        <div class="row">
                            ...
                            <small class="mb-1 d-flex justify-content-end d-md-none d-sm-block d-block me-2">
                                ...
                                <a href="procesoCaard.php?delete={{ $productoArray->id }}"
                                    class="text-danger icons--delete--cart"> <i class="bi bi-trash"></i></a>
                            </small>
                            <div
                    ...
                    <div class="col col-md-6  d-none d-sm-none d-md-block">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('deleteCart.user.main', $productoArray->id) }}"
                                class="text-danger icons--delete--cart"> <i class="bi bi-trash"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-12 col-md-3  boxBodyCartInfoMain">
      <div class="mb-4 col-sm-1  p-4 rounded-3 shadow box--view--favorite-- boxBodyCartInfoCompra boxBodyCartInfo">
          <h5 class="mb-4 ">Resumen de la compra:</h5>
          {{-- <h4>{{session()->get('userId')}}</h4> <h4>{{session()->get('name')}}</h4> --}}
          ...
          <div class="col">
              ...
              <div class="container">
                  <div class="row d-flex justify-content-center">
                      ...
                      <a href="{{ route('viewProducto.home.list') }}"
                          class="col-md-12 col-12 btn btn--paymet--ir mb-3 btnEfectClick" data-bs-toggle="modal"
                          data-bs-target="#Mpayment"><i class="bi bi-paypal me-2"></i>Pagar</a>
                  </div>
              </div>
          </div>
      </div>
      <div class="mb-3 col-  p-4 rounded-3 shadow box--view--favorite-- boxBodyCartInfo">
          ...
          <div class="col">
              <div class="container">
                  <div class="row d-flex justify-content-center">
                      <a href="{{ route('download.user.pdf') }}"
                      ...
                      <a href="{{ route('deleteTotalCart.user.main') }}"
