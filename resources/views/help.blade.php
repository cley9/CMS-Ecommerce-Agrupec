...
<div class="container-fluid style--body-content p-5">
      ...
      <div class="container mb-5 " >
        <div class="row text-center">
          ...
          <h6 class="h4  fw-normal">Resolver tus consultas ahora es más fácil a través de nuestros <h6 class="h4 help--number mb-5">canales de atención.</h6> </h6>
        ...
        <div class="mb-0">
        <small class=" h6 help--number">123  <small class="h6 fw-normal text-muted">desde tu Bitel</small></small>
        </div>
        <div class="mb-0">
        <small class=" h6 help--number">{{config('constants.numProvincia')}} <small class="h6 fw-normal text-muted">desde Provincias y sin costo</small></small>
        </div>
        <div class="mb-2">
        <small class=" h6 help--number">+51 {{config('constants.numContact')}} <small class="h6 fw-normal text-muted">desde otro operador</small></small>
        </div>
            </div>
          </div>
        </div>
      ...
      <div class=" pt-2 pt-md-5 col-12 d-flex justify-content-center ">
        ...
        <div class="mb-5 ">
          ...
          <img src="{{asset('storage/img/icons/logoVentas.png')}}" class="img-flid" alt="" >
      ...
      <div class="   bg-light border--box-help pt-md-1  mb-5 ">
        ...
        <div class="mb-md-0 mb-2 text-center p-md-2 ">
          <a href="https://play.google.com/store/apps" target="_blank"> <img src="{{asset('storage/img/icons/google-play.png')}}" class="img-fluid col-md-12 col-10 "  alt=""> </a>
        </div>
        <div class="mb-md-0 mb-2 text-center p-md-2">
          <a href="https://www.apple.com/la/search/app?src=globalnav" target="_blank"> <img src="{{asset('storage/img/icons/app-store.png')}}" class="img-fluid col-md-12 col-10 "  alt=""> </a>
        </div>
        <div class="mb-0 text-center p-md-2">
          <a href="https://appgallery.huawei.com/#/Categories" target="_blank"> <img src="{{asset('storage/img/icons/app-gallery.png')}}" class="img-fluid col-md-12 col-10" alt=""> </a>
        </div>
      </div>
      </div>
      </div>
      ...
      <br>
                             Correo: gmail</p>
                             <div class=" text-center  ">
                  <a class="foda--view"href="contactenos.php" ><i class="bi bi-telephone-plus "></i></a>
                </div>
        </div>
        </div>
