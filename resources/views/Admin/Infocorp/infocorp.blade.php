...
<div class="text-center">
    ...
    <button type="button" id="btnListener__" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modelFactura" data-bs-whatever="@fat" data-bs-backdrop="static" data-bs-keyboard="false" >Crear factura</button>
  </div>
            ...
            <form action="">
                <div class="row row-cols-md-2">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="cSelect" id="nameP_" class="form-control"  placeholder="Ingrese el nombre del producto" required />
                    </div>
                    {{--  <div class="mb-3">
                    ...
                    <label for="message-text" class="col-form-label">Consulta sunat:</label>
                      <div class="input-group mb-3">
                        <input type="text"  maxlength="8" size="8" minlength='11' class="form-control vNumInfo" id="vNumInfocorp" placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="basic-addon2" required>
                          <span type='button' class="input-group-text" id="vBtnSearch"><i class="bi bi-search"></i>INFOCORP</span>
                        </div>
...
{{--  <a id="fBtnSearch">dfa</a>  --}}
                        {{--  <button>
                             ...
                             <form method="post" action="{{route('save.admin.list')}}" id="formSave" enctype="multipart/form-data" >
                                ...
                                <div class="row row-cols-md-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="fNombreUser" class="form-control" id="vNombreUser"  placeholder="Ingrese el numero de rut" required/>
                                    </div>
                                    <div class="mb-3">
                                        <label class="col-form-label">Numero de Dni:</label>
                                        <input type="text" name="cRut" class="form-control" id="vNumero"  placeholder="Ingrese el numero de rut" required/>
                                    </div>

                                    <div class="mb-3">
                                        <label class="col-form-label">Tipo de documento :</label>
                                        <input type="text" name="cRut" class="form-control" id="fTipoDocumento" placeholder="Ingrese el numero de rut" required/>
                                    </div>
{{--
                                    <div class="mb-3">
