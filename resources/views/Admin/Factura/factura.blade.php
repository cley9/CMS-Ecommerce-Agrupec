            ...
            <form action="">
                <div class="row row-cols-md-2">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <div class="input-group mb-3">
                          <input type="text"  maxlength="11" size="11" minlength='11' class="form-control fNumRut" id="fNumRut" placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="basic-addon2" required>
                          <span type='button' class="input-group-text" id="fBtnSearch"><i class="bi bi-search"></i>SUNAT</span>
                        </div>
                             ...
                             <form method="post" action="{{route('save.admin.list')}}" id="formSave" enctype="multipart/form-data" >
                                ...
                                <div class="row row-cols-md-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="fNombreUser" class="form-control" id="fNombreUser"  placeholder="Ingrese el numero de rut" required/>
                                    </div>
                                    <div class="mb-3">
                                        <label class="col-form-label">Numero de Rut:</label>
                                        <input type="text" name="cRut" class="form-control" id="fNumero"  placeholder="Ingrese el numero de rut" required/>
                                    </div>
