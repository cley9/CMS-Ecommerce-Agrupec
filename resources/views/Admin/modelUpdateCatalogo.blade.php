  ...
  <div class="modal fade  " id="modelUpdateCatalogo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content "   >
        ...
        <div class="modal-body">
            <form method="post" action="{{route('update.admin.catalogo')}}" id="formSave" enctype="multipart/form-data" >
        @csrf
    ...
    <div class="row row-cols-md-2 row-cols-1">
        <div class="mb-3">
            ...
            <input type="text" name="nombre" id="updateCatalogoNombre" class="form-control"  placeholder="Ingrese el nombre del producto" required />
          </div>


          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Descripcion de catalogo:</label>
            <input type="text" name="descripcion" id="updateCatalogoDescripcion" class="form-control"  placeholder="Ingrese la descripcion del producto" required/>
          </div>
          <div class="mb-3 col-md-12 ">
           <div class="col text-center d-flex justify-content-center">
                ...
                <img class="mb-3 card-img-top" src="" height="150" width="250" id="updateCatalogoImg" alt="Imagen prevista..." />
            </div>
              <div class="mb-3">
                <input type="file" class="form-control" onchange="previewFile()" id="updateCatalogoFile"  name="imagen" aria-describedby="fileHelp" name="imagen"  accept="image/*" >
              </div>
            </div>
        </div>
