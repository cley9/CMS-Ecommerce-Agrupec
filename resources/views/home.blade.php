      ...
      <div class="col-11 card- post-slide- border bg-info- slay-box-item">
        <div class="row d-flex- justify-content-between-">
          <dir class="col-6 bg-primary- me-2 ">
            <a href="{{route('View.home.index', $id=$itemProducto['id'])}}" class="p-2 carrusel-min-pro">
              <img src="{{asset('storage/img/Productos/'.$itemProducto['imagen'].'')}}" class="img-fluid-a slay-img-item" height="120px" width="140px" alt="">
          </a></dir>
          <div class="col-5 pt-2 bg-warning-s  ">
            ...
            <div class=" d-flex justify-content-center">
              <a  href="{{route('View.home.index', $id=$itemProducto['id'])}}" class="btn btn-sm  btn--view-add btn-slay-producto-">Ver Producto   </a>
            </div>
          </div>
        </div>
        </div>
...
<div class=" pt-3 mb-4  d-flex justify-content-center align-items-center">
      <div class=" col-md-10 col-10 d-flex justify-content-center align-items-center  pt-2 rounded-3 title--producto-group">
  ...
  <div class="row row row-cols-2 row-cols-sm-3  row-cols-md-4 row-cols-lg-5 row-cols-xl-6 d-flex justify-content-center ">
          @foreach ($producto as $key)
          <div class="col  mb-5 mb-lg-6 ">
              <div class="card-  box-love shadow bg-info_ rouded-4" style="height: 340px;" >
              <div class="overlay ">
            <a class="icons--love "  ><i class="bi bi-heart"></i></a>
            </div>
            <a href="{{route('View.home.index', $id=$key['id'])}}">
         <img src="{{ asset('storage/img/Productos/'.$key['imagen'].'') }}"  class=" card-img-top" width="200px" height="120px" alt="">
         <div class="card-body">
  ...
  <span class="text-dark">s/ {{$key['newPrecio']}}</span>
     ...
     <small>{{$key['cantidad']}} disponibles </small>  </span>
      ...
      <div class=" d-flex justify-content-between align-items-center mb-3">
        <a class="btn--addCard--countMaster btn-sm text-dark viewCP" id="addProCard{{$key['id']}}">Agregar</a>
            </div>
      <div class="d-flex justify-content-between align-items-center ">
             <a  class="des{{$key['id']}} btn rounded-circle  btn--addCard--count fw-normal">-</a>
         <span id="numDate{{$key['id']}}"  >1</span>
          <a  class="start{{$key['id']}} btn rounded-circle btn--addCard--count" >+</a>
          </div>
     ...
     <div class=" d-flex justify-content-center align-items-center">
         <a  href="{{route('View.home.index', $id=$key['id'])}}" class="btn btn-sm  btn--view-add">Ver Producto   </a>
          </div>
   @endif
        </div>
  </div>
